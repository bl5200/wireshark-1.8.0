...
*
* $Id: dtd_grammar.lemon 40806 2012-02-02 11:54:33Z jmayer $
*
...
#line 943 "dtd_grammar.c"
        break;
      case 9: /* attrib_list ::= attrib_list attrib */
#line 148 "./dtd_grammar.lemon"
...
#line 166 "./dtd_grammar.lemon"
{
  yy_destructor(14,&yymsp[0].minor);
}
#line 1007 "dtd_grammar.c"
        break;
...
#line 1153 "dtd_grammar.c"
        break;
      case 43: /* element_child ::= NAME PLUS */
#line 219 "./dtd_grammar.lemon"
{
	yygotominor.yy44 = g_ascii_strdown(yymsp[-1].minor.yy0->text, -1);
	g_free(yymsp[-1].minor.yy0->text);
    g_free(yymsp[-1].minor.yy0->location);
