...
register_all_protocol_handoffs(register_cb cb, gpointer client_data)
{
  ...
  {extern void proto_reg_handoff_dmx_chan (void); if(cb) (*cb)(RA_HANDOFF, "proto_reg_handoff_dmx_chan", client_data); proto_reg_handoff_dmx_chan ();}
  {extern void proto_reg_handoff_dmx_sip (void); if(cb) (*cb)(RA_HANDOFF, "proto_reg_handoff_dmx_sip", client_data); proto_reg_handoff_dmx_sip ();}
  {extern void proto_reg_handoff_dmx_test (void); if(cb) (*cb)(RA_HANDOFF, "proto_reg_handoff_dmx_test", client_data); proto_reg_handoff_dmx_test ();}
  {extern void proto_reg_handoff_dmx_text (void); if(cb) (*cb)(RA_HANDOFF, "proto_reg_handoff_dmx_text", client_data); proto_reg_handoff_dmx_text ();}
